        ...
        <!-- Topbar -->
            ...
            <div class="container-fluid" id="container-wrapper">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{url('/').'/admin/'.$categoryID.'/addItem'}}">Add Items</a></li>
                    </ol>
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="table-responsive p-3">
                                <table class="table align-items-center table-flush" id="dataTable">
                                    ...
                                    <tr>
                                        <td>{{$MainList->foodItemsID}}</td>
                                        <td>{{$MainList->itemName}}</td>
                                        <td>{{$MainList->itemPrice}}</td>
                                        <td>&nbsp;
                                            <a href="{{url('/').'/admin/'.$MainList->foodItemsID.'/editItem'}}">Edit</a>|&nbsp;
                                            <a href="javascript:void(0)" onclick="deleteCategory({{$MainList->foodItemsID}})">Delete</a>
                                        </td>
                                    </tr>
                                        @endforeach
                                      @else
...
<script>
    function deleteCategory(id) {
        ...
        if(x){
            baseurl='{{url('/')}}';
            var ajax_url = baseurl + '/admin/deleteItem';
            $.ajax({
                url: ajax_url,
                type: 'GET',
                data: "itemID=" + id ,
