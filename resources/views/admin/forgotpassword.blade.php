                            ...
                            <div class="login-form">
                                ...
                                <form method="post" action="{{ url('/') }}/admin/forgotPassword">
                                    ...
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input name="email" type="text" class="form-control" id="exampleInputPassword" placeholder="Email Address">
                                    </div>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="font-weight-bold small" href="{{url('/')}}/admin/login">Back To Login?</a>
                                </div>
                                <div class="text-center">
                                </div>
                            </div>
