...
<header class="header_area" style="background: #7676ff;">
    <div class="main_menu">
        ...
        <div class="hero-right">
            <div class="owl-carousel owl-theme hero-carousel">
                <div class="hero-carousel-item">
                    <img class="img-fluid" src="{{url('/')}}/public/front/img/banner/hero-banner1.png" alt="">
                </div>
                <div class="hero-carousel-item">
                    <img class="img-fluid" src="{{url('/')}}/public/front/img/banner/hero-banner2.png" alt="">
                </div>
                <div class="hero-carousel-item">
                    <img class="img-fluid" src="{{url('/')}}/public/front/img/banner/hero-banner1.png" alt="">
                </div>
    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-theme featured-carousel">
            <div class="featured-item">
                <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/featured1.png" alt="">
                <div class="item-body">
                    <a href="#">
            ...
            <div class="featured-item">
                <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/featured2.png" alt="">
                <div class="item-body">
                    <a href="#">
            ...
            <div class="featured-item">
                <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/featured3.png" alt="">
                <div class="item-body">
                    <a href="#">
...
<section class="bg-lightGray section-padding">
    <div class="container">
        <div class="row no-gutters">
            <div class="col-sm">
                <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/offer-img.png" alt="">
            </div>
            <div class="col-sm">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div class="chef-card">
                    <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/chef-1.png" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div class="chef-card">
                    <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/chef-2.png" alt="">
                    <div class="chef-footer">
                        <h4>Daniesl Laran</h4>
                        <p>Executive Chef</p>
                    </div>
            ...
            <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
                <div class="chef-card">
                    <img class="card-img rounded-0" src="{{url('/')}}/public/front/img/home/chef-3.png" alt="">
                    <div class="chef-footer">
                        <h4>Daniesl Laran</h4>
                        <p>Executive Chef</p>
                    </div>
...
<script src="{{url('/')}}/public/front/front/vendors/Magnific-Popup/jquery.magnific-popup.min.js"></script>
